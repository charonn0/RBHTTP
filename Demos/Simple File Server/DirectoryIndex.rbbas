...
Inherits HTTP.Response
	#tag Method, Flags = &h0
		Sub Constructor(Target As FolderItem, ServerPath As String)
		  ...
		  Super.Constructor("HTTP/1.0 200 OK" + HTTP.CRLF)
	...
	#tag Method, Flags = &h1
		Protected Shared Function GetIcon(ext As String) As String
		  ext = Lowercase(ext)
		  
		  Select Case ext
		  Case "exe", "com", "scr", "pif", "dll", "deb", "rpm"
		    Return "/" + FileServer.VirtualRoot + "/img/bin.png"
		    
		  Case "js", "cs", "c", "h", "vbs", "vbe", "bat", "cmd", "sh", "ini", "reg"
		    Return "/" + FileServer.VirtualRoot + "/img/script.png"
		    
		  Case "rbp", "rbbas", "rbvcp", "rbfrm", "rbres"
		    Return "/" + FileServer.VirtualRoot + "/img/xojo.png"
		    
		  Case "folder"
		    Return "/" + FileServer.VirtualRoot + "/img/dir.png"
		    
		  Case "txt", "md"
		    Return "/" + FileServer.VirtualRoot + "/img/txt.png"
		    
		  Case "htm", "html"
		    Return "/" + FileServer.VirtualRoot + "/img/html.png"
		    
		  Case "css"
		    Return "/" + FileServer.VirtualRoot + "/img/css.png"
		    
		  Case "xml", "xsl"
		    Return "/" + FileServer.VirtualRoot + "/img/xml.png"
		    
		  Case "jpg", "jpeg", "png", "bmp", "gif", "tif"
		    Return "/" + FileServer.VirtualRoot + "/img/image.png"
		    
		  Case "mov", "mp4", "m4v", "avi", "mpg", "mpeg", "wmv", "mkv"
		    Return "/" + FileServer.VirtualRoot + "/img/mov.png"
		    
		  Case "ttf", "otf", "pfb", "pfm"
		    Return "/" + FileServer.VirtualRoot + "/img/font.png"
		    
		  Case "zip", "tar", "rar", "7zip", "bzip", "gzip", "7z", "tgz", "gz", "z"
		    Return "/" + FileServer.VirtualRoot + "/img/zip.png"
		    
		  Case "wav"
		    Return "/" + FileServer.VirtualRoot + "/img/wav.png"
		    
		  Case "mp3", "m4a", "m4b", "m4p", "ogg", "flac"
		    Return "/" + FileServer.VirtualRoot + "/img/mus.png"
		    
		  Case "pdf", "ps"
		    Return "/" + FileServer.VirtualRoot + "/img/pdf.png"
		    
		  Case "xls", "xlsx"
		    Return "/" + FileServer.VirtualRoot + "/img/xls.png"
		    
		  Case "doc", "docx"
		    Return "/" + FileServer.VirtualRoot + "/img/doc.png"
		    
		  Else ' This returns the default icon
		    Return "/" + FileServer.VirtualRoot + "/img/unknown.png"
	...
	#tag Method, Flags = &h0
		Sub Populate()
		  ...
		  If RequestPath.ServerPath <> "/" Then
		    ...
		    PageData = ReplaceAll(PageData, "%UPLINK%", "<img src=""/" + FileServer.VirtualRoot + "/img/upicon.png"" width=22 height=22 /><a href=""" + s + """>Parent Directory</a>")
		  Else
		    PageData = ReplaceAll(PageData, "%UPLINK%", "")
		  End If
		  Dim head As String = TableHeader
		  If dir = 0 Then
		    head = ReplaceAll(head, "%SORTICON%", "/" + FileServer.VirtualRoot + "/img/sorticon.png")
		    head = ReplaceAll(head, "%DIRECTION%", "&dir=1")
		  Else
		    head = ReplaceAll(head, "%SORTICON%", "/" + FileServer.VirtualRoot + "/img/sortup.png")
