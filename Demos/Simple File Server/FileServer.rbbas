...
Inherits HTTP.BaseServer
	...
	#tag Method, Flags = &h1000
		Sub Constructor()
		  ...
		  doc.MessageBody = "User-Agent: *" + HTTP.CRLF + "Disallow: /" + HTTP.CRLF + HTTP.CRLF
	...
	#tag Property, Flags = &h21
		Private Shared mVirtualRoot As String
	#tag EndProperty
