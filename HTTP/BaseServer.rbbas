...
Inherits ServerSocket
	...
	#tag Method, Flags = &h1
		Protected Shared Function GetFileResponse(page As FolderItem, Path As String, RangeStart As Integer = 0, RangeEnd As Integer = - 1) As HTTP.Response
	...
	#tag Method, Flags = &h1
		Protected Shared Function GetRedirectResponse(Path As String, RedirectURL As String) As HTTP.Response
